...
def add_preprocess_args(parser):
    ...
    group.add_argument("--byte-tokens", action="store_true",
                       help="tokenize at the byte level instead of the word level")
    group.add_argument("--char-tokens", action="store_true",
                       help="tokenize at the character level instead of the word level")
    # fmt: on
    return parser
...
def add_dataset_args(parser, train=False, gen=False):
    ...
    group.add_argument('--byte-data',  type=str, metavar='N',
                        help='number of batches to preload')
    group.add_argument('--max-byte-tokens', default=10, type=int, metavar='N',
                        help='number of batches to preload')
    group.add_argument('--char-or-bpe-data', type=str, metavar='N',
                        help='number of batches to preload')
    group.add_argument('--ratio', default=10, type=float, metavar='N',
                        help='number of batches to preload')
...
def add_checkpoint_args(parser):
    ...
    group.add_argument('--precision', type=int, default=6, metavar='N',
